...
/**
 * The {@link MutableSendableChooser} class is a useful tool for presenting a selection of options to the
 * {@link SmartDashboard}.
 *
 ...
 * MutableSendableChooser} and then put it into the {@link SmartDashboard} to have a list of options appear
 * on the laptop. Once autonomous starts, simply ask the {@link SendableChooser} what the selected
 * value is.
 *
 * @param <V> The type of the values to be stored
 */
public class MutableSendableChooser<V> implements Sendable, AutoCloseable {
    ...
    /** Instantiates a {@link MutableSendableChooser}. */
