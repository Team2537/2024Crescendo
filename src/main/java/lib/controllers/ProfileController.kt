...
/**
 * Wrapper class for any [Gamepad] that applies the currently active [Profile][DriverProfile.DriverProfile]
 *
 * @see Gamepad
 * @see DriverProfile
 */
class ProfileController(private val gamepad: Gamepad, val name: String = "null") {
    var profile: DriverProfile = DriverProfile.default
    ...
    val dPadUpLeft: Trigger = gamepad.dPadUpLeft.toTrigger()
    val dPadUpRight: Trigger = gamepad.dPadUpRight.toTrigger()
    val dPadDownRight: Trigger = gamepad.dPadDownRight.toTrigger()
    val dPadDownLeft: Trigger = gamepad.dPadDownLeft.toTrigger()
