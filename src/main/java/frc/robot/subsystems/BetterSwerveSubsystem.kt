...
object BetterSwerveSubsystem : SubsystemBase() {
    ...
    fun getPathCommand(path: String, resetOdometry: Boolean): Command {
        val traj: ChoreoTrajectory = Choreo.getTrajectory(path)
